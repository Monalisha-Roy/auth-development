            ...
            <div className="bg-white px-16 py-3 w-96">
                ...
                <form action="" className="flex flex-col gap-4">
                    ...
                    <div className="relative">
                        ...
                        <div onClick={() => router.push('/forgot-password')} className="text-[#365486] text-xs hover:cursor-pointer">
                            forgot password
                        </div>
                    ...
                    <button 
                        ...
                        className="bg-[#365486] rounded-lg text-white py-2 hover:scale-105 duration-300 flex justify-center">Login</button>
                </form>
                ...
                <div className="text-xs text-black flex justify-center mt-1">
                    <p>
                        ...
                        <a className="text-blue-700 hover:cursor-pointer">Register</a>
                    </p>
                </div>
            </div>   
        </main>
